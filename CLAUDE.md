...
- **自動生成フッター禁止**: Claude Codeの自動生成フッターを追加しない
...
fix(backend): WebSocket接続エラーを修正
docs: CLAUDE.mdにコミットルールを追加
refactor(frontend): Redux storeの構造を改善
chore(infra): Docker Compose設定を追加
```
